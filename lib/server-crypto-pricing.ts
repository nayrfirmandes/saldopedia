...
const FALLBACK_PRICES: PriceSnapshot = {
  "bitcoin": { idr: 1650000000, idr_24h_change: 1.5 },
  "ethereum": { idr: 60000000, idr_24h_change: 2.1 },
  "tether": { idr: 16000, idr_24h_change: 0.01 },
  "usd-coin": { idr: 16000, idr_24h_change: 0.02 },
  "binancecoin": { idr: 10500000, idr_24h_change: 1.8 },
  "solana": { idr: 3800000, idr_24h_change: 3.2 },
  "ripple": { idr: 38000, idr_24h_change: 2.5 },
  "cardano": { idr: 16000, idr_24h_change: 1.2 },
  "dogecoin": { idr: 6500, idr_24h_change: 4.1 },
  "tron": { idr: 4200, idr_24h_change: 1.1 },
  "polygon-ecosystem-token": { idr: 8500, idr_24h_change: 2.8 },
  "the-open-network": { idr: 95000, idr_24h_change: 3.5 },
  "shiba-inu": { idr: 0.38, idr_24h_change: 5.2 },
  "pancakeswap-token": { idr: 42000, idr_24h_change: 1.9 },
  "floki": { idr: 2.8, idr_24h_change: 6.1 },
  "tokocrypto": { idr: 5200, idr_24h_change: 0.8 },
  "baby-doge-coin": { idr: 0.000045, idr_24h_change: 7.3 },
  "dogs-2": { idr: 12, idr_24h_change: 4.5 },
  "notcoin": { idr: 150, idr_24h_change: 3.8 },
};
