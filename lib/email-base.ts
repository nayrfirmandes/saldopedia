  ...
  return `
    <tr>
      <td class="header-bg" style="padding: 32px 24px 24px; text-align: center; background-color: #ffffff;">
        <img src="https://${getPrimaryDomain()}/images/saldopedia-logo.jpeg" alt="Saldopedia" width="56" height="56" style="display: block; margin: 0 auto 12px; border-radius: 12px;">
