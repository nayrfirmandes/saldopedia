      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          <div className="pb-12 text-center">
            <h1 className="mb-4 border-y text-4xl font-bold [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] dark:[border-image:linear-gradient(to_right,transparent,--theme(--color-slate-700/.8),transparent)1] md:text-5xl dark:text-gray-100">
          ...
          <div>
            ...
            <div className="mx-auto grid max-w-sm items-start gap-4 md:max-w-3xl md:grid-cols-3">
              <div className="relative flex h-full flex-col rounded-xl bg-gradient-to-br from-gray-900 to-gray-700 p-5 shadow-md transition-all duration-200 hover:shadow-lg">
                ...
                <div className="mt-6">
                  <a
                    className="btn-sm w-full rounded-lg bg-linear-to-t from-blue-600 to-blue-500 bg-[length:100%_100%] bg-[bottom] py-2 text-white shadow-sm hover:bg-[length:100%_150%]"
                    href="/order"
                  >
                    ...
                    {serviceType === "jual" ? (
                      <div>
                        ...
                        <div className="space-y-1.5">
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$20 - $49</span>
                            <span className="text-lg font-bold text-gray-900 dark:text-gray-100">Rp 12.000</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$50 - $499</span>
                            <span className="text-lg font-bold text-blue-600 dark:text-blue-400">Rp 14.000</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$500 - $1.999</span>
                            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">Rp 15.000</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$2.000 - $5.000</span>
                            <span className="text-lg font-bold text-emerald-700 dark:text-emerald-400">Rp 15.299</span>
                          </div>
                        </div>
                      </div>
                    ) : (
                      <div>
                        ...
                        <div className="space-y-1.5">
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$20 - $49</span>
                            <span className="text-lg font-bold text-gray-900 dark:text-gray-100">Rp 17.699</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$50 - $499</span>
                            <span className="text-lg font-bold text-blue-600 dark:text-blue-400">Rp 17.299</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$500 - $1.999</span>
                            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">Rp 16.999</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$2.000 - $5.000</span>
                            <span className="text-lg font-bold text-emerald-700 dark:text-emerald-400">Rp 16.789</span>
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {serviceType === "jual" ? (
                      <div>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$50 - $499</span>
                            <span className="text-lg font-bold text-purple-600 dark:text-purple-400">Rp 14.000</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$500 - $1.999</span>
                            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">Rp 15.000</span>
                      ...
                      <div>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$50 - $499</span>
                            <span className="text-lg font-bold text-purple-600 dark:text-purple-400">Rp 17.299</span>
                          </div>
                          <div className="flex items-baseline justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">$500 - $1.999</span>
                            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400">Rp 16.999</span>
