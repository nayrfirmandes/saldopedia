        ...
        <div className="py-12 md:py-20">
          <div className="pb-12 text-center md:pb-16">
            <AnimateOnScroll animation="fade-up">
              <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.800),theme(colors.blue.600),theme(colors.gray.800))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent dark:bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.blue.400),theme(colors.gray.200))] md:text-4xl">
