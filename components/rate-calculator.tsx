...
export default function RateCalculator() {
  ...
  // Fetch cryptocurrency prices on mount and every 3 minutes
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        ...
        console.error("Failed to fetch cryptocurrency prices:", error instanceof Error ? error.message : error);
  ...
  const getCalculation = () => {
    ...
    if (service === "cryptocurrency") {
      ...
      if (mode === "convert") {
        return calculateCryptoFromCoin(selectedCrypto, numAmount, marketPrice, mode);
      }
      
      return calculateCryptoFromIDR(selectedCrypto, numAmount, marketPrice, mode);
    }
  ...
  const tierInfo = service !== "cryptocurrency" && amount ? getTierInfo(parseFloat(amount), mode) : null;
  ...
  const getMinCoinAmount = () => {
    ...
    return getMinimumCoinAmount(selectedCrypto, marketPrice, mode);
  };
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          <div className="pb-12 text-center md:pb-16">
            <h1 className="mb-4 border-y text-4xl font-bold [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] md:text-5xl dark:text-gray-100">
            ...
            <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-lg md:p-8 dark:border-gray-700 dark:bg-gray-800">
              ...
              {!showResult && (
                <button
                  ...
                  className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-3.5 text-base font-semibold text-white shadow-lg transition-all hover:from-blue-700 hover:to-blue-600 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50 md:py-4 md:text-lg"
                >
                  {isCalculating ? (
              ...
              {showResult && (
                <div className="mt-8 animate-[fadeIn_0.4s_ease-out]">
                  ...
                  <div className="mt-6 space-y-3 md:mt-8">
                    <a
                      href="/order"
                      className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-3.5 text-sm font-semibold text-white shadow-lg transition hover:from-blue-700 hover:to-blue-600 hover:shadow-xl md:py-4 md:text-base"
                    >
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm transition hover:border-gray-400 hover:bg-gray-50 hover:shadow md:text-base dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                    >
