    ...
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Planet */}
          <AnimateOnScroll animation="zoom-y-out" className="pb-16 md:pb-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-1.5 flex items-center space-x-2 font-medium text-gray-200">
                <svg
                ...
                <span>{t('featuresPlanet.autoTx.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.autoTx.description')}
              </p>
            </article>
            <article>
              <h3 className="mb-1.5 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t('featuresPlanet.minTx.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.minTx.description')}
              </p>
            </article>
            <article>
              <h3 className="mb-1.5 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t('featuresPlanet.safe.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.safe.description')}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t('featuresPlanet.variety.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.variety.description')}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t('featuresPlanet.bestRate.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.bestRate.description')}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t('featuresPlanet.fastProcess.title')}</span>
              </h3>
              <p className="text-base text-gray-400">
                {t('featuresPlanet.fastProcess.description')}
              </p>
            </article>
          </div>
        </div>
