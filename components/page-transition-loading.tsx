    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="relative w-10 h-10">
          ...
          <div className="spinner-ring absolute inset-0 border-[2.5px] border-transparent border-t-blue-500 dark:border-t-blue-400 border-r-blue-500 dark:border-r-blue-400 rounded-full"></div>
        </div>
