...
const LOGO_CONTAINER_BASE = "flex items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl";
...
const TAB_BUTTON_BASE = "ui-focus-visible:outline-none ui-focus-visible:ring ui-focus-visible:ring-blue-300 flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-lg px-3 text-base font-semibold transition-all duration-200 focus-visible:outline-hidden";
const TAB_BUTTON_ACTIVE = "bg-gray-800 text-gray-200 dark:bg-blue-500 dark:text-white shadow-sm";
...
function DecorativeLines() {
  return (
    <>
      <div className="absolute inset-x-0 top-0 -z-10 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700" />
      <div className="absolute inset-x-0 bottom-0 -z-10 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700" />
      ...
      <div className="absolute inset-x-0 top-1/2 -z-10 h-px -translate-y-[82px] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700 before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_both] before:bg-linear-to-r before:via-blue-500" />
      <div className="absolute inset-x-0 top-1/2 -z-10 h-px translate-y-[82px] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700 before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_5s_both] before:bg-linear-to-r before:via-blue-500" />
      <div className="absolute inset-x-[300px] top-1/2 -z-10 h-px rotate-[20deg] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700" />
      <div className="absolute inset-x-[300px] top-1/2 -z-10 h-px -rotate-[20deg] bg-linear-to-r from-transparent via-gray-200 to-transparent mix-blend-multiply dark:via-gray-700" />
      <div className="absolute inset-y-0 left-1/2 -z-10 w-px -translate-x-[216px] bg-linear-to-b from-gray-200 to-transparent mix-blend-multiply dark:from-gray-700" />
      <div className="absolute inset-y-0 left-1/2 -z-10 w-px translate-x-[216px] bg-linear-to-t from-gray-200 to-transparent mix-blend-multiply dark:from-gray-700" />
    </>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div suppressHydrationWarning>
          <TabGroup selectedIndex={selectedTab} onChange={setSelectedTab}>
            ...
            <TabPanels 
              className="relative flex h-[324px] items-center justify-center transition-all duration-700"
              style={{
                opacity: isVisible ? 1 : 0,
