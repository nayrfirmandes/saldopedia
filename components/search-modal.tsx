...
export default function SearchModal({ isOpen, setIsOpen, onSearch }: SearchModalProps) {
  ...
  const popularSearches = [
    t("supportPage.searchModal.suggestions.minimal"),
    t("supportPage.searchModal.suggestions.howToStart"),
    t("supportPage.searchModal.suggestions.processTime"),
    t("supportPage.searchModal.suggestions.paypal"),
    t("supportPage.searchModal.suggestions.safe"),
    t("supportPage.searchModal.suggestions.crypto"),
    t("supportPage.searchModal.suggestions.tier"),
    t("supportPage.searchModal.suggestions.skrill"),
  ];
              ...
              <div className="p-2">
                ...
                <ul className="space-y-1">
                  {popularSearches.map((search, index) => {
                    const matchingFaq = allFaqs.find(
                      (faq) =>
                    ...
                    return (
                      <li key={index}>
                        ...
                        >
                          ...
                          <span className="font-medium">{matchingFaq?.question || search}</span>
                        </button>
                      </li>
                    );
                  })}
