          ...
          <div className="pb-12 pt-32 md:pb-20 md:pt-40">
            ...
            <div className="mb-8">
              ...
              <div className="mt-8 text-center">
                <Link
                  href="/order"
                  className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-purple-500 to-fuchsia-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:shadow-md transition-all hover:from-purple-600 hover:to-fuchsia-700 dark:from-purple-600 dark:to-fuchsia-700 dark:hover:from-purple-700 dark:hover:to-fuchsia-800"
                >
