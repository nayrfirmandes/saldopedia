...
export default function Hamburger() {
  ...
  return (
    <button
      className="group inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white text-center shadow-md hover:shadow-lg border border-gray-200 transition-all duration-200 hover:bg-blue-50 hover:border-blue-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:border-gray-600"
