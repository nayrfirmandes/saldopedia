      ...
      <div className="text-center">
        <div className="mt-6 inline-block max-w-md rounded-xl bg-white px-6 py-4 shadow-lg shadow-black/[0.03] dark:bg-gray-800 dark:shadow-black/20">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400 dark:focus:border-blue-400"
            rows={3}
          />
