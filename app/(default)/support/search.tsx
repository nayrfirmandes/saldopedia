    ...
    <div>
      ...
      >
        <div className="flex items-center justify-center">
          <svg
            className="mr-3 h-4 w-4 shrink-0 fill-gray-500 dark:fill-gray-400"
            width={16}
            height={16}
            viewBox="0 0 16 16"
          ...
          <span className="dark:text-gray-300">
            {t("supportPage.search.placeholder")}
            <span className="hidden sm:inline">
              {" "}
              {t("supportPage.search.placeholderDetail")}{" "}
            </span>
            …
          </span>
        </div>
        <div className="ml-3 flex gap-1">
          <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-white text-gray-400 shadow-xs dark:bg-gray-700 dark:text-gray-500">
            <svg
      ...
      <SearchModal isOpen={searchModalOpen} setIsOpen={setSearchModalOpen} onSearch={onSearch} />
    </div>
  );
}
