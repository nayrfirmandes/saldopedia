...
export default function OrderExpiredLoading() {
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          <div className="mx-auto max-w-md text-center animate-pulse">
            ...
            <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-56 mx-auto mb-8"></div>
            <div className="h-11 bg-gray-200 dark:bg-gray-700 rounded-lg w-40 mx-auto"></div>
          </div>
        </div>
      </div>
    </section>
