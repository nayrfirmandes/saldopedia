      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-4 border-y text-4xl font-bold dark:text-gray-100 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] dark:[border-image:linear-gradient(to_right,transparent,--theme(--color-slate-700/.8),transparent)1] md:text-5xl" >
            ...
            <div className="mx-auto max-w-xs sm:max-w-none sm:flex sm:justify-center"  >
              <a
                className="btn group w-full rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md transition-shadow duration-200 hover:shadow-lg sm:w-auto"
                href="/order"
              >
