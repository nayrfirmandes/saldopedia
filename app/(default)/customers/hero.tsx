      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-10 text-center">
            <h1 className="mb-6 border-y text-5xl font-bold [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] md:text-6xl dark:text-gray-100">
