...
const paypalSans = localFont({
  src: [
    {
      path: '../public/fonts/PayPalSansBig-Light-Klim.woff2',
      weight: '300',
      style: 'normal',
    },
    {
      path: '../public/fonts/PayPalSansSmall-Regular-Klim.woff2',
      weight: '400',
      style: 'normal',
    },
    {
      path: '../public/fonts/PayPalSansSmall-Medium-Klim.woff2',
      weight: '600',
      style: 'normal',
    },
    {
      path: '../public/fonts/PayPalSansBig-Regular-Klim.woff2',
      weight: '700',
      style: 'normal',
    },
  ],
  variable: '--font-paypal-sans',
  display: 'swap',
  preload: true,
});
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`scroll-smooth ${paypalSans.variable}`} data-scroll-behavior="smooth" suppressHydrationWarning>
      <head>
        <script
