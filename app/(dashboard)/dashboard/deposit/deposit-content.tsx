...
export default function DepositContent({ user }: { user: User }) {
  ...
  const handleStep2Submit = async (e: React.FormEvent) => {
    ...
    if (!depositDetails) {
      setError('Data deposit tidak ditemukan');
      return;
    }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-6">{t('dashboardPages.deposit.title')}</h1>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Min {formatIDR(MIN_DEPOSIT)} - Max {formatIDR(MAX_DEPOSIT)}
              </p>
            </div>
          </div>
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2">
                  <p className="text-3xl font-bold text-amber-700 dark:text-amber-300">
                    {formatIDR(depositDetails.totalAmount)}
                  </p>
                  <button
                    type="button"
