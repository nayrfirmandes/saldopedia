              ...
              {transferAmount >= minimumTransfer && (
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900 dark:text-white font-medium">{formatIDR(transferAmount)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">{t('dashboardPages.transfer.amount')}</span>
                    <span className="font-bold text-blue-600 dark:text-blue-400 text-lg">{formatIDR(transferAmount)}</span>
                  </div>
                  {notes && (
                    <div className="flex justify-between text-sm">
                  ...
                  <div className="border-t border-blue-200 dark:border-blue-700 pt-3 flex justify-between">
                    ...
                    <span className="font-bold text-gray-900 dark:text-white">{formatIDR(remainingSaldo)}</span>
                  </div>
                </div>
              </div>
